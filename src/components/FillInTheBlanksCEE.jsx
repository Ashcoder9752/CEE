...
import { abilityToCode, languageReasoning, analyticalReasoning, aptitude } from "../data/fillInTheBlanksData.js";
import SectionTitle from "./SectionTitle.jsx";
import QuestionPaperCard from "./QuestionPaperCard.jsx";
import FillInTheBlanksPaperForm from "./FillInTheBlanksPaperForm.jsx";
    ...
    return (
        <div className="max-w-7xl mx-auto py-10 px-6 text-white">
            {!selectedPaper ? (
                ...
                <FillInTheBlanksPaperForm paper={selectedPaper} onBack={handleBack} />
            )}
        </div>
    );
}

export default FillInTheBlanksCEE;